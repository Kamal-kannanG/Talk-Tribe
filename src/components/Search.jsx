        ...
        <>
         ...
         <div className="search"> 
            <div className="searchForm">
                <input className="srbar" type="text" placeholder="Find a user" 
                onKeyDown={handleKey} onChange={(e)=>setUserName(e.target.value)} value={userName}/>
            </div>
            {err && <span>User not Found!</span>}
            { user && (
                <div className="userChat" onClick={handleSelect}>
                <img className="sr-img" src={user.photoURL} alt="" />
                <div className="userChatInfo">
                    <span className="sr-sp">{user.displayName}</span>
                </div>
            </div>
            )}
        </div>
